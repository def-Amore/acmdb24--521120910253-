...
public class TupleDesc implements Serializable {
    ...
    public static class TDItem implements Serializable {
        ...
        public boolean equals(Object o) {
            if (o != null && o instanceof TDItem) {
                return fieldType.equals(((TDItem) o).fieldType);
            }
            return false;
        }
    }
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        ...
        String[] nameAr = new String[l1 + l2];
        for (int i = 0; i < l1; i++) {
            TDItem tmp = td1.items.get(i);
            typeAr[i] = tmp.fieldType;
            nameAr[i] = tmp.fieldName;
        }
        for (int i = 0; i < l2; i++) {
            TDItem tmp = td2.items.get(i);
            typeAr[l1 + i] = tmp.fieldType;
            nameAr[l1 + i] = tmp.fieldName;
        }
    ...
    public boolean equals(Object o) {
        // some code goes here
        if (o == null) return items == null;
        else return o instanceof TupleDesc && items.equals(((TupleDesc) o).items);
    }
    ...
    public String toString() {
        ...
        tmp += items.get(numFields() - 1).toString();
        return tmp;
    }
}
